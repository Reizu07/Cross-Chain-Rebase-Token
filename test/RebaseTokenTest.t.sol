...
contract RebaseTokenTest is Test {
    ...
    function testTransfer(uint256 amount, uint256 amountToSend) public {
        ...
        // Note: we're testing transfer functionality, not interest rate
        // Interest rate is set in setUp, no need to change it here
        ...
        // check the user interest rate has ben inhertited (5e10 not 4e10)
